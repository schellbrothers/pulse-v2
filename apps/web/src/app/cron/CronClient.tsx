...
const FEEDS: FeedDef[] = [
  ...
  },
  {
    num: 7,
    name: "Zoom Calls",
    description: "Sales team phone calls from Zoom Phone API",
    schedule: "Every 15 min (7am-8pm)",
    script: "hbx-sync-zoom-calls.py",
    filterCol: "source",
    filterVal: "zoom_calls",
    times: [],
  },
  {
    num: 8,
    name: "Zoom Meetings",
    description: "Zoom meeting recordings and transcripts",
    schedule: "3× Daily",
    script: "hbx-sync-zoom-meetings.py",
    filterCol: "source",
    filterVal: "zoom_meetings",
    times: ["6:10 AM", "12:10 PM", "6:10 PM"],
  },
  {
    num: 9,
    name: "Transcription",
    description: "Call transcripts via Zoom + Whisper AI backfill",
    schedule: "Every 30 min (7am-8pm)",
    script: "hbx-transcribe-calls.py",
    filterCol: "source",
    filterVal: "transcription",
    times: [],
  },
  {
    num: 10,
    name: "Outlook Emails",
    description: "Sales email sync from Grace's Outlook via Microsoft Graph",
    schedule: "Every 15 min (7am-8pm)",
    script: "hbx-sync-outlook-emails.py",
    filterCol: "source",
    filterVal: "outlook_emails",
    times: [],
  },
  {
    num: 11,
    name: "SMS (Webhook)",
    description: "Real-time Zoom SMS via webhook — no cron needed",
    schedule: "Real-time",
    script: "/api/webhooks/zoom",
    filterCol: "source",
    filterVal: "zoom_sms_webhook",
    times: [],
  },
  {
    num: 12,
    name: "Staff Assignments",
    description: "CSM + OSC assignments from Heartbeat → user table",
    schedule: "Daily 5 AM",
    script: "hbx-sync-staff-assignments.py",
    filterCol: "source",
