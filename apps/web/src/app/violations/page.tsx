...
const SLA_LABELS: Record<string, string> = {
  ...
  osc_route: "OSC Route",
  osc_afterhours: "After-Hours Queue",
  osc_form_schedule_visit: "Schedule Visit",
  osc_form_in_person_traffic: "In-Person Traffic",
  osc_form_zillow_lead: "Zillow/Portal Lead",
  osc_form_schellie_conversion: "Schellie Conversion",
  osc_form_interested: "Interested",
  osc_form_rsvp: "RSVP",
  osc_form_prelaunch: "Prelaunch",
  osc_form_subscribe_community: "Subscribe Community",
  osc_form_subscribe_region: "Subscribe Region",
  csm_rank: "CSM Rank",
